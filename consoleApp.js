...
/////////// esercizio di scrittura da Javascript a html attraverso un comando .innerHTML

function changeText(){
    let element = document.getElementById("firstParagraph");
    element.innerHTML = prompt("Inserisci il testo che vuoi analizzare");
...
function writeStatsOfParagraph(string) {
    ...
    element.innerHTML = statsParagraph(text);
    return element
}
